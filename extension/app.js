! function (e) {
    ...
    const r = [null, "#202020", "#9600FF", "#7F00D8", "#555555", "#454545", "#353535", "#252525"];
    shapes = [
        [
            [1, 1, 1],
            [0, 1, 0],
    ...
    function _(e = 0) {
        if (g && function () {
                ...
                o.font = .7 * l + "px Arial", o.fillStyle = "#ff5b5b", o.fillText(r, n.width / 2 - o.measureText(r).width / 2 + t, 9 * l + t), o.font = l + "px Arial", o.fillStyle = "#9600FF", o.fillText(e, n.width / 2 - o.measureText(e).width / 2, 8 * l), o.font = .7 * l + "px Arial", o.fillStyle = "#9600FF", o.fillText(r, n.width / 2 - o.measureText(r).width / 2, 9 * l)
            }(), o.fillStyle = "black", o.fillRect(0, 0, n.width, n.height), o.fillStyle = "#9600FF", o.fillRect(0, 3 * l - 1, n.width, 1), O(i, {
                x: 0,
                y: 0
            }), O(N.shape, {
                x: N.x,
